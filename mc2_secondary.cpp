...
void Simulation::initializeVarDict()
   ...
   VarDict[VTYPE].max_categories = 50;
   ...
   VarDict[BIOME].max_categories = 10;
   ...
   VarDict[PHYSIOGNOMIC_CLASS].max_categories = 20;
   ...
   makeVarDictEntry(PSL, "PSL", "precipitation at sea level per PNW-GTR-841", "mmH2O", NC_FLOAT, YEAR_INTERVAL);
   ...
   makeVarDictEntry(MATSL, "MATSL", "mean air temperature at sea level per PNW-GTR-841", "deg C", NC_FLOAT, YEAR_INTERVAL);
